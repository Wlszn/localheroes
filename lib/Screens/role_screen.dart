              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                      Text('I Need Help', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, wordSpacing: 4),),
                    ]),
                    SizedBox(height: 10,),
                    Text('Post tasks and find qualified local helpers to assist you with various jobs.' ,softWrap: true, ),
                    SizedBox(height: 20,),
                    Text('Post tasks and describe what you need \n'
                        'Browse verified heroes near you \n'
                        'Track progress and make secure payments',style:  TextStyle(height: 2), ),
                    SizedBox(height: 20,),
                    Row(
                      children: [
            ...
            child:    Card(
              child: Padding(
                ...
                child: Column(
                  children: [
                    Row( children: [
                      Icon(Icons.work, color: Colors.pink[300],)
                    ]
                    ),
                    SizedBox(height: 20,),
                    Row(
                        children: [
                          Text('I Can Help', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, wordSpacing: 4),),
                        ]),
                    SizedBox(height: 10,),
                    Text('Earn money by offering your skills and helping people in your community.' ,softWrap: true, ),
                    SizedBox(height: 20,),
                    Text('Find jobs that match your skills \n'
                        'Set your own schedule and rates \n'
                        'Build your reputation and earn more',style:  TextStyle(height: 2), ),
                    SizedBox(height: 20,),
                    Row(
                      children: [
                        TextButton(onPressed: () {
